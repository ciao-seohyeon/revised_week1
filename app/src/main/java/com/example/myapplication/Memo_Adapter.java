...
public class Memo_Adapter extends RecyclerView.Adapter<Memo_Adapter.ViewHolder> {
    ...
    // 데이터를 전달받아온다.
    public Memo_Adapter(ArrayList<Memo_data_class> list){
        memo_data = list;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ViewHolder(View Memo_data_class){
            ...
            title = Memo_data_class.findViewById(R.id.memo_title);
            date = Memo_data_class.findViewById(R.id.memo_date);
        }
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Memo_data_class item_data = memo_data.get(position);
